 ...
 * 时间选择器
 */
public class DateTimeChooserJButton extends JButton {
    ...
    public DateTimeChooserJButton() {
        this(getNowDate());
    }

    public DateTimeChooserJButton(String dateString) {
        this();
    ...
    public DateTimeChooserJButton(SimpleDateFormat df, String dateString) {
        this();
    ...
    public DateTimeChooserJButton(Date date) {
        this("", date);
        //记忆原始日期时间
        initOriginalText(date);
    }

    public DateTimeChooserJButton(String preLabel, Date date) {
        if (preLabel != null) {
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {
        ...
        private JPanel createYearAndMonthPanal() {
            ...
            JLabel yearLabel = new JLabel(CommonConstant.YEAR);
            ...
            JLabel monthLabel = new JLabel(CommonConstant.MONTH);
...
//            daySpin.setToolTipText("请下下面的日历面板中进行选择哪一天！");
            ...
            JLabel dayLabel = new JLabel(CommonConstant.DAY);
            ...
            JLabel hourLabel = new JLabel(CommonConstant.HOUR);
            ...
            JLabel minuteLabel = new JLabel(CommonConstant.MINUTE);
            hourLabel.setForeground(controlTextColor);
            ...
            JLabel secondLabel = new JLabel(CommonConstant.SECOND);
            hourLabel.setForeground(controlTextColor);
        ...
        private JPanel createWeekAndDayPanal() {
            String colname[] = CommonConstant.WEEK;
            JPanel result = new JPanel();
            // 设置固定字体，以免调用环境改变影响界面美观
            result.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 12));
        ...
        private JDialog createDialog(JDialog owner) {
            JDialog result = new JDialog(owner, "日付時間選択", true);
        ...
        void showDateChooser(Point position) {
            JDialog owner = (JDialog) SwingUtilities.getWindowAncestor(DateTimeChooserJButton.this);
...
//        mainFrame.add(new DateTimeChooserJButton(), java.awt.BorderLayout.CENTER);
//
