...
public class ScriptUtils {
	 ...
	 * @throws Exception 
	 */
	public static void copyById(String strScriptId, String strScriptName, String strEndMail, String strErrorMail) throws IOException {
		ComDao comDao = new ComDao();
		...
		String strToPath = listDao.createScriptData(strNewScriptId, strFileName, strScriptName, strEndMail, strErrorMail);
