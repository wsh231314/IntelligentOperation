...
public class RunHelp {
    ...
    public void runCurrentScript(String strScriptPath, String strEvidencePath, boolean testExec, String strEndMail, String strErrorMail) {
        ...
        final SubRun doRun = new SubRun(srunners, strScriptPath, absoPath, testExec, strEndMail, strErrorMail);
    ...
    private class SubRun implements Runnable {
        ...
        private boolean blnTestExec =  false;
        
        private String evidencePath = "";
        
        private String strEndMail = "";
        
        private String strErrorMail = "";

        public SubRun(IScriptRunner[] srunners, String scriptFile, String evidencePath, boolean testExec, String strEndMail, String strErrorMail) {
        	this.evidencePath = evidencePath;
            this.srunners = srunners;
            this.scriptFile = scriptFile;
            this.blnTestExec = testExec;
            this.strEndMail = strEndMail;
            this.strErrorMail = strErrorMail;
        }
        ...
        public void run() {
            try {
                ...
                srunners[0].runScript(fScript, null, new String[]{evidencePath, String.valueOf(blnTestExec), strEndMail, strErrorMail}, null);
            } catch (Exception ex) {
            	ex.printStackTrace();
            }
            hasFinished(true);
