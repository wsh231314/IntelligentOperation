...
//						jPanel.add(first);
	...
	public String[] getPageInfoByDataRow (int iRow) {
		String []strResult = new String[]{"", ""};
		
		String strPage = String.valueOf((int)((iRow - 1)/ iPageSize) + 1);
		
		String strRow = String.valueOf(iRow - ((Integer.parseInt(strPage) - 1) * iPageSize) + 1);
