...
public class JythonScriptRunner implements IScriptRunner {
    ...
    public void init(String[] param) {
        ...
        try {
            ...
            helper.getSysPath();
            String fpAPI = null;
            String[] possibleJars = new String[]{"sikulixapi", "API/target/classes", "sikulix.jar", "autoOperation.jar"};
     ...
     */
    @Override
    public synchronized int runScript(File pyFile, File fScriptPath, String[] argv, String[] forIDE) {
        if (null == pyFile) {
