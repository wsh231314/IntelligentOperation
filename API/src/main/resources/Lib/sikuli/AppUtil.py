...
def initEvidence():
    ...
    GlobalVar._init()
    GlobalVar.set_value('evidence_excel',evidence_excel);
    GlobalVar.set_value('evidence_excel_file_path',evidence_excel_path);
...
from org.app.co.jp.com import MailManager as JMailManager

class MailManager(JMailManager):
    pass

def mail_by_id(mail_id):
    return MailManager.sendMailById(mail_id, GlobalVar.get_value('evidence_excel_file_path'))
